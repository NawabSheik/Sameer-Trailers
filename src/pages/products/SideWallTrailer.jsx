...
import TipTrailers from "../../assets/product-img/side-wall-trailer.webp";
import TipTrailersMobile from "../../assets//product-thumbnail/side-wall-trailer.webp";
  ...
  return (
    <div className="product-page">
      ...
      <div className="product-head">
        <h2 className="product-page-name">Side Wall Trailer</h2>
      </div>
          ...
          <div className="product-info-col-1">
            ...
            <div className="product-info-desc">
              <ul>
                ...
                <li className="product-desc-pointer">Fixed front and side panel, drop down rear door</li>
                <li className="product-desc-pointer">1 window provided at the centre on both sides.</li>
